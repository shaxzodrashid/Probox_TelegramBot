...
const buildCandidateSearchText = (candidate: FaqCandidateRecord): string => {
  return [
    ...
    candidate.faq.retrieval_profile?.intent_description || '',
    ...(candidate.faq.retrieval_profile?.utterances_uz || []),
    ...(candidate.faq.retrieval_profile?.utterances_ru || []),
    ...(candidate.faq.retrieval_profile?.utterances_en || []),
