...
admin_faq_question_prompt = Yangi savolni istalgan tilda yuboring:
admin_faq_processing_questions = Savol variantlari tayyorlanmoqda...
admin_faq_generated_questions_title = FAQ savol variantlari
admin_faq_source_question_label = Asl savol
admin_faq_similar_questions_label = Eng yaqin 5 ta FAQ
admin_faq_no_similar_questions = O'xshash nashr qilingan FAQ topilmadi.
admin_faq_generated_variants_label = Yaratilgan savol variantlari
