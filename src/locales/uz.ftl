...
admin_broadcast_weekly = 🗓 Haftalik avtomatik
...
admin_broadcast_schedule_confirm = Bu xabar har hafta { $weekday } kuni soat { $time } da { $count } ta foydalanuvchiga avtomatik yuborilsinmi?
...
admin_broadcast_schedule_saved = ✅ Haftalik avtomatik xabar saqlandi: { $weekday }, { $time }.
